...
var cat = new Object();
cat[""]=[""];
cat["filmvidéo"]=["animation","animation-serie","concert","documentaire","emission-tv","film","serie-tv","spectacle","sport","video-clips"];
cat["audio"]=["karaoke","musique","podcast-radio","samples"];
